...
The antidote to all of this fear is a functional testing suite. As I discussed in a [Getting Creative with MapReduce](http://sritchie.github.com/2011/09/29/getting-creative-with-mapreduce.html), Hadoop workflows are difficult to test at all; testing application logic in isolation of data storage is impossible.
